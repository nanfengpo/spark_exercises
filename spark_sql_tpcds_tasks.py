...
def start_job(namespace, query):
	subprocess.check_output("/home/ubuntu/software/spark-1.5.0-bin-hadoop2.6/bin/beeline -u jdbc:hive2://10.0.1.86:10000/tpcds_text_db_1_50 -n ubuntu -p ignored -f /home/ubuntu/workload/hive-tpcds-tpch-workload/sample-queries-tpcds/"+query+".sql 2> /home/ubuntu/workload/hive-tpcds-tpch-workload/output/"+namespace+"_tpcds_"+query+"__spark.out", shell=True)
